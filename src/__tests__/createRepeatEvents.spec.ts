  ...
  describe('반복 일정 테스트', () => {
    ...
    it('입력한 종료 날짜까지 1일마다 매일 반복되는 일정을 생성한다.', () => {
      const dailyEvent: Event = {
        ...
        location: '사무실',
        category: '업무',
        repeat: { type: 'daily', interval: 1, endDate: '2024-10-10' },
        notificationTime: 10,
      };
    ...
    it('입력한 종료 날짜까지 1주마다 매주 반복되는 일정을 생성한다.', () => {
      ...
      expect(resultDate).toEqual(['2024-10-14', '2024-10-21', '2024-10-28']);
    });
    it('입력한 종료 날짜까지 1달마다 매월 반복되는 일정을 생성한다.', () => {
      const monthlyEvent: Event = {
        ...
        location: '사무실',
        category: '업무',
        repeat: { type: 'monthly', interval: 1, endDate: '2025-01-01' },
        notificationTime: 10,
      };
      ...
      expect(resultDate).toHaveLength(3);
      expect(resultDate).toEqual(['2024-11-01', '2024-12-01', '2025-01-01']);
    });
    ...
    it('입력한 종료 날짜까지 1년마다 매년 반복되는 일정을 생성한다.', () => {
      const yearlyEvent: Event = {
        ...
        location: '사무실',
        category: '업무',
        repeat: { type: 'yearly', interval: 1, endDate: '2026-10-31' },
        notificationTime: 10,
      };
      ...
      expect(resultDate).toHaveLength(3);
      expect(resultDate).toEqual(['2024-10-31', '2025-10-31', '2026-10-31']);
    });
    ...
    it('종료 날짜를 입력하지 않으면 2025-06-30까지만 반복 일정이 생성된다.', () => {
      ...
      expect(resultDate).toHaveLength(6);
      expect(resultDate).toEqual([
        '2025-01-15',
        '2025-02-15',
        '2025-03-15',
